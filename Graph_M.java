...
public class Graph_M {
    ...
    public static void Create_Metro_Map(Graph_M g) {
        g.addVertex("Dumdum~B");
        g.addVertex("Shyambazar~B");
        g.addVertex("Esplanade~B");
        g.addVertex("Park Street~B");
        g.addVertex("Kalighat~B");
        g.addVertex("Howrah~B");
        g.addVertex("Maidan~B");
        g.addVertex("Kavi Subhas~Y");
        g.addVertex("Tollygunge~Y");
        g.addVertex("Kasba~Y");
        g.addVertex("Dhakuria~Y");
        g.addVertex("Garia~YO");
        g.addVertex("Kavi Subhas~Y");
        g.addVertex("Ruby~Y");
        g.addVertex("Salt Lake Stadium~O");
        g.addVertex("Nicco Park~O");
        g.addVertex("Sealdah~YB");
        g.addVertex("Bidhannagar~YB");
        g.addVertex("Girish Park~PR");

        g.addEdge("Dumdum~B", "Shyambazar~B", 8);
        g.addEdge("Shyambazar~B", "Esplanade~B", 10);
        g.addEdge("Esplanade~B", "Kalighat~B", 8);
        g.addEdge("Kalighat~B", "Park Street~B", 6);
        g.addEdge("Park Street~B", "Howrah~B", 9);
        g.addEdge("Howrah~B", "Maidan~B", 7);
        g.addEdge("Maidan~B", "Kavi Subhas~Y", 6);
        g.addEdge("Tollygunge~Y", "Kasba~Y", 15);
        g.addEdge("Kasba~Y", "Ruby~Y", 6);
        g.addEdge("Ruby~Y", "Garia~YO", 7);
        g.addEdge("Garia~YO", "Kavi Subhas~Y", 8);
        g.addEdge("Sealdah~YB", "Bidhannagar~YB", 2);
        g.addEdge("Girish Park~PR", "Sealdah~YB", 3);
    }
            ...
            switch (choice) {
                ...
                case 5:
                    ...
                    if (!g.containsVertex(s1) || !g.containsVertex(s2) || !g.hasPath(s1, s2, processed2))
                        System.out.println("No such path exists between these two stations!");
                    else {
